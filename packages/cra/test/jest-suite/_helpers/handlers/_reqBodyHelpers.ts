...
const areSameValues = (expectedData: any, req: MockedRequest, key: string): boolean => {
...
const areSameArrayValues = (expectedData: any, req: MockedRequest, key: string): boolean => {
    // @ts-ignore
...
const areSameBasicValues = (expectedData: any, req: MockedRequest, key: string): boolean => {
    // @ts-ignore
    const data = req.body[key];
...
const printError = (expectedData: any, req: MockedRequest, key: string): void => {
    // @ts-ignore
    const data = req.body[key];
